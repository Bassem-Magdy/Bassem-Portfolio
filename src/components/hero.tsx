        ...
        <motion.div {...anim}>
          ...
          >
            ...
            <span className="mt-2 block bg-brand-gradient bg-clip-text text-transparent">
              I build fast interfaces and solve hard problems.
            </span>
          </motion.h1>

          <motion.p {...child} className="mt-6 max-w-xl text-lg leading-relaxed text-slate-400">
            {site.tagline}. Codeforces Expert, ECPC 2026 finalist, crafting polished React &amp; Next.js experiences
            backed by an algorithmic mindset.
          </motion.p>
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-ink-900/90 shadow-2xl backdrop-blur">
        ...
        <pre className="overflow-x-auto p-5 font-mono text-[13px] leading-7 text-slate-300">
          <code>
            ...
            {"\n  "}role: <span className="text-emerald-300">&quot;Front-End Dev&quot;</span>,
            {"\n  "}stack: [<span className="text-emerald-300">&quot;React&quot;</span>, <span className="text-emerald-300">&quot;Next.js&quot;</span>, <span className="text-emerald-300">&quot;.NET&quot;</span>],
            {"\n  "}codeforces: {"{"}
            {"\n    "}handle: <span className="text-emerald-300">&quot;Hero_777&quot;</span>,
